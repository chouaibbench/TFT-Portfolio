...
const ProjectCard = ({ project, onClick }) => {
  return (
    <div
      ...
      className="group relative cursor-pointer overflow-hidden rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-[#8b5cf6]/50 transition-all duration-500"
      role="button"
      tabIndex={0}
    ...
    >
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          <div>
            <span className="text-xs font-mono font-semibold uppercase tracking-widest text-[#8b5cf6] mb-1 block">
              {project.category}
            </span>
          ...
          <div className="p-2 rounded-full bg-zinc-800 text-zinc-400 group-hover:bg-[#8b5cf6] group-hover:text-white transition-all duration-300 transform group-hover:-translate-y-1 group-hover:translate-x-1">
